...
export const LoginForm = () => {
    ...
    return (
        <div className="relative z-10 h-svh flex w-full items-center justify-center">
            <Card className="w-full max-w-md border border-neutral-40 dark:border-neutral-80 rounded-md shadow-md bg-neutral-10/80 dark:bg-neutral-90/70 backdrop-blur-md px-3 pb-1">
                <div className="space-y-8">
                    <header className="space-y-2 text-center">
                        <p className="text-xs w-fit  mx-auto px-4 rounded-b-sm py-0.5 uppercase tracking-[0.35em] dark:bg-neutral-90/80 bg-neutral-60/80 text-neutral-10 border border-t-0 border-neutral-40 dark:border-neutral-80 dark:text-neutral-40">Etmify- HR</p>
